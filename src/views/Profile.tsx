            ...
            <>
              ...
              <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
                ...
                <div className="space-y-4">
                  ...
                  <label className="flex items-center justify-between p-3 bg-slate-50 border border-slate-100 rounded-xl cursor-pointer hover:border-indigo-200 transition">
                    <div>
                      <span className="text-xs font-bold text-slate-800 block">Enable 5% GST on Billing</span>
                      <span className="text-[10px] text-slate-500">Automatically calculate and append GST to invoices.</span>
                    </div>
                    <input 
                      type="checkbox" 
                      checked={gstEnabled} 
