  ...
  try {
    ...
    if (menuCount === 0 || !hasSaojiMenu) {
      ...
      const menuToSeed = [
        ...
        { _id: 'm_veg_2', name: 'डाळ कांदा (Dal Kanda)', category: 'Vegetarian', portionMode: 'Single', price: 250, variants: [], prepTime: 15, isAvailable: true },
        { _id: 'm_veg_3', name: 'शेव भाजी (Shev Bhaji)', category: 'Vegetarian', portionMode: 'Single', price: 250, variants: [], prepTime: 12, isAvailable: true },
        ...
        { _id: 'm_veg_5', name: 'कोल्हापुरी पनीर (Kolhapuri Paneer)', category: 'Vegetarian', portionMode: 'Single', price: 280, variants: [], prepTime: 15, isAvailable: true },
        ...
        { _id: 'm_veg_9', name: 'डाळ फ्राय (Dal Fry)', category: 'Vegetarian', portionMode: 'Single', price: 200, variants: [], prepTime: 10, isAvailable: true },
        { _id: 'm_veg_10', name: 'डाळ तडका (Dal Tadka)', category: 'Vegetarian', portionMode: 'Single', price: 230, variants: [], prepTime: 12, isAvailable: true },
        { _id: 'm_veg_11', name: 'टोमॅटो चटणी (Tomato Chutney)', category: 'Vegetarian', portionMode: 'Single', price: 250, variants: [], prepTime: 12, isAvailable: true },
        ...
        { _id: 'm_egg_2', name: 'वेज अंडाकरी फ्राय (Veg Egg Curry Fry)', category: 'Egg Curry', portionMode: 'Single', price: 200, variants: [], prepTime: 15, isAvailable: true },
        { _id: 'm_egg_3', name: 'फ्राय अंडाकरी नॉन-व्हेज (Fry Egg Curry Non-Veg)', category: 'Egg Curry', portionMode: 'Single', price: 220, variants: [], prepTime: 15, isAvailable: true },
        { _id: 'm_egg_4', name: 'अंडाकरी नॉन-व्हेज (Egg Curry Non-Veg)', category: 'Egg Curry', portionMode: 'Single', price: 200, variants: [], prepTime: 15, isAvailable: true },
        ...
        { _id: 'm_bread_8', name: 'भाकरी (Bhakri)', category: 'Breads', portionMode: 'Single', price: 35, variants: [], prepTime: 6, isAvailable: true },
        ...
        { _id: 'm_rice_2', name: 'जीरा राईस (Jeera Rice)', category: 'Rice', portionMode: 'Variant', price: 0, variants: [{ name: 'Half', price: 60, prepTime: 8 }, { name: 'Full', price: 100, prepTime: 12 }], prepTime: 10, isAvailable: true },
        ...
        { _id: 'm_nst_3', name: 'खिमा कलेजी (Kheema Kaleji)', category: 'Starters', portionMode: 'Single', price: 390, variants: [], prepTime: 15, isAvailable: true },
        { _id: 'm_nst_4', name: 'गार्लिक खिमा (Garlic Kheema)', category: 'Starters', portionMode: 'Single', price: 410, variants: [], prepTime: 15, isAvailable: true },
        { _id: 'm_nst_5', name: 'सुंदरी स्टार्टर (Sundari Starter)', category: 'Starters', portionMode: 'Single', price: 320, variants: [], prepTime: 15, isAvailable: true },
        { _id: 'm_nst_6', name: 'ग्रीन मटन (Green Mutton)', category: 'Starters', portionMode: 'Single', price: 380, variants: [], prepTime: 18, isAvailable: true },
        { _id: 'm_nst_7', name: 'गार्लिक ग्रीन मटन (Garlic Green Mutton)', category: 'Starters', portionMode: 'Single', price: 400, variants: [], prepTime: 18, isAvailable: true },
        ...
        { _id: 'm_nst_9', name: 'गार्लिक मटन (Garlic Mutton)', category: 'Starters', portionMode: 'Single', price: 400, variants: [], prepTime: 18, isAvailable: true },
        ...
        { _id: 'm_nst_12', name: 'गार्लिक सुखा चिकन (Garlic Sukha Chicken)', category: 'Starters', portionMode: 'Single', price: 400, variants: [], prepTime: 15, isAvailable: true },
        { _id: 'm_nst_13', name: 'गार्लिक काटीचा चिकन (Garlic Katicha Chicken)', category: 'Starters', portionMode: 'Single', price: 470, variants: [], prepTime: 18, isAvailable: true },
        { _id: 'm_nst_14', name: 'सुखा काटीचा चिकन (Sukha Katicha Chicken)', category: 'Starters', portionMode: 'Single', price: 450, variants: [], prepTime: 18, isAvailable: true },
        ...
        // 7. करी (Curries)
        { _id: 'm_cur_1', name: 'झिंगा करी (Prawns Curry)', category: 'Curries', portionMode: 'Variant', price: 0, variants: [{ name: 'Half', price: 280, prepTime: 12 }, { name: 'Full', price: 380, prepTime: 18 }], prepTime: 15, isAvailable: true },
        { _id: 'm_cur_2', name: 'सुंदरी करी (Sundari Curry)', category: 'Curries', portionMode: 'Variant', price: 0, variants: [{ name: 'Half', price: 220, prepTime: 12 }, { name: 'Full', price: 320, prepTime: 18 }], prepTime: 15, isAvailable: true },
        ...
        { _id: 'm_cur_4', name: 'गार्लिक खिमा कलेजी (Garlic Kheema Kaleji)', category: 'Curries', portionMode: 'Single', price: 410, variants: [], prepTime: 15, isAvailable: true },
        ...
        { _id: 'm_cur_7', name: 'गार्लिक मटन करी (Garlic Mutton Curry)', category: 'Curries', portionMode: 'Variant', price: 0, variants: [{ name: 'Half', price: 300, prepTime: 15 }, { name: 'Full', price: 400, prepTime: 20 }], prepTime: 18, isAvailable: true },
        ...
        { _id: 'm_cur_9', name: 'गार्लिक चिकन करी (Garlic Chicken Curry)', category: 'Curries', portionMode: 'Variant', price: 0, variants: [{ name: 'Half', price: 300, prepTime: 12 }, { name: 'Full', price: 400, prepTime: 18 }], prepTime: 15, isAvailable: true },
        ...
        { _id: 'm_cur_11', name: 'गार्लिक खुर करी (Garlic Khur Curry)', category: 'Curries', portionMode: 'Variant', price: 0, variants: [{ name: 'Half', price: 300, prepTime: 18 }, { name: 'Full', price: 420, prepTime: 25 }], prepTime: 20, isAvailable: true },
        { _id: 'm_cur_12', name: 'काटीचा कोंबडा (Katicha Kombda)', category: 'Curries', portionMode: 'Single', price: 450, variants: [], prepTime: 18, isAvailable: true },
        { _id: 'm_cur_13', name: 'गार्लिक काटीचा कोंबडा (Garlic Katicha Kombda)', category: 'Curries', portionMode: 'Single', price: 470, variants: [], prepTime: 18, isAvailable: true },
        ...
        { _id: 'm_handi_2', name: 'सुखा मटन हांडी (Sukha Mutton Handi)', category: 'Handi Dishes', portionMode: 'Variant', price: 0, variants: [{ name: 'Half', price: 650, prepTime: 20 }, { name: 'Full', price: 1200, prepTime: 30 }], prepTime: 25, isAvailable: true },
        ...
        { _id: 'm_handi_7', name: 'काटीचा कोंबडा हांडी (Katicha Kombda Handi)', category: 'Handi Dishes', portionMode: 'Variant', price: 0, variants: [{ name: 'Half', price: 850, prepTime: 25 }, { name: 'Full', price: 1600, prepTime: 40 }], prepTime: 35, isAvailable: true },
        { _id: 'm_handi_8', name: 'सुखा काटीचा कोंबडा हांडी (Sukha Katicha Kombda Handi)', category: 'Handi Dishes', portionMode: 'Variant', price: 0, variants: [{ name: 'Half', price: 850, prepTime: 25 }, { name: 'Full', price: 1600, prepTime: 40 }], prepTime: 35, isAvailable: true }
      ];
